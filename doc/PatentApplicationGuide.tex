...
dot com)\\
Copyright \textcopyright 2012 Peter J. Pupalaikis\\
Version: 1.0\\
...
\texttt{\textbackslash{}dependentClaimsStart}
...
\vskip 1 em
\texttt{\textbackslash{}dependentClaimsEnd}
\vskip 1 em
...
\begin{flushright}
\textbf{\tiny ---START OF DEPENDENT CLAIMS---}
\par\end{flushright}{\tiny \par}
...
\begin{flushright}
\textbf{\tiny ---END OF DEPENDENT CLAIMS---}
\par\end{flushright}{\tiny \par}
...
Dependent claims can be placed into an indented list
with the nested \texttt{\textbackslash{}dependentClaimsStart} and \texttt{\textbackslash{}dependentClaimsEnd}
\index{dependentClaimsStart macro@\textbackslash{}dependentClaimsStart macro}\index{LaTeX@\LaTeX{}!macro!dependentClaimsStart@\textbackslash{}dependentClaimsStart}\index{dependentClaimsEnd macro@\textbackslash{}dependentClaimsEnd macro}\index{LaTeX@\LaTeX{}!macro!dependentClaimsEnd@\textbackslash{}dependentClaimsEnd}macros
in \LaTeX{} or the \textbf{DependentClaimsStart} and \textbf{DependentClaimsEnd} \index{DependentClaimsStart environment}\index{LyX@\LyX{}!environment!DependentClaimsStart}\index{DependentClaimsEnd environment}\index{LyX@\LyX{}!environment!DependentClaimsEnd}environments
in \LyX{}. These also take no arguments.
...
\dependentClaimsStart
  ...
  The method of \claimRef{Claim1} further comprising\ldots (a very long line of text will wrap correctly to the next line, with an appropirate indentation.)
...
\dependentClaimsStart
  ...
  The method of \claimRef{Claim2} further comprising\ldots
